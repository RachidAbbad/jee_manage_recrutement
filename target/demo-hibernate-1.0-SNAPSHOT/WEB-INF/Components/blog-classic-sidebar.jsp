            ...
            <div class="row">
                ...
                <div class="col-lg-8 col-md-7 col-sm-12">
                    ...
                    <div class="blog-post blog-lg blog-style-1">
                        <div class="dez-post-media dez-img-effect zoom-slow radius-sm"><a href="#"><img
                                src="images/blog/default/thum2.jpg" alt=""></a></div>
                        <div class="dez-info">
                            ...
                            <div class="dez-post-title ">
                                <h4 class="post-title font-24"><a href="#">Do you have a job that the average person
                                    doesn�t even know exists?</a></h4>
                            </div>
                    ...
                    <div class="blog-post blog-lg blog-style-1">
                        <div class="dez-post-media dez-img-effect zoom-slow radius-sm"><a href="#"><img
                                src="<%=request.getContextPath()%>/WEB-INF/Assets/images/blog/default/thum1.jpg" alt=""></a>
                        </div>
                        <div class="dez-info">
                            <div class="dez-post-meta">
                                <ul class="d-flex align-items-center">
                    ...
                    <div class="blog-post blog-lg blog-style-1">
                        <div class="dez-post-media dez-img-effect zoom-slow radius-sm"><a href="#"><img
                                src="<%=request.getContextPath()%>/WEB-INF/Assets/images/blog/default/thum4.jpg" alt=""></a>
                        </div>
                        <div class="dez-info">
                            <div class="dez-post-meta">
                                <ul class="d-flex align-items-center">
                    ...
                    <div class="blog-post blog-lg blog-style-1">
                        <div class="dez-post-media dez-img-effect zoom-slow radius-sm"><a href="#"><img
                                src="<%=request.getContextPath()%>/WEB-INF/Assets/images/blog/default/thum3.jpg" alt=""></a>
                        </div>
                        <div class="dez-info">
                            <div class="dez-post-meta">
                                <ul class="d-flex align-items-center">
                            ...
                            <div class="widget-post-bx">
                                <div class="widget-post clearfix">
                                    <div class="dez-post-media"><img
                                            src="<%=request.getContextPath()%>/WEB-INF/Assets/images/blog/recent-blog/pic1.jpg"
                                ...
                                <div class="widget-post clearfix">
                                    <div class="dez-post-media"><img
                                            src="<%=request.getContextPath()%>/WEB-INF/Assets/images/blog/recent-blog/pic2.jpg"
                                ...
                                <div class="widget-post clearfix">
                                    <div class="dez-post-media"><img
                                            src="<%=request.getContextPath()%>/WEB-INF/Assets/images/blog/recent-blog/pic3.jpg"
                                            width="200" height="160" alt=""></div>
                                    <div class="dez-post-info">
                                        <div class="dez-post-header">
