            ...
            <div class="row">
                    ...
                    <div class="p-a30 border m-b30 contact-area border-1 align-self-stretch radius-sm">
                        ...
                        <ul class="no-margin">
                            ...
                            <li class="icon-bx-wraper left">
                                <div class="icon-bx-xs border-1"><a href="#" class="icon-cell"><i class="ti-mobile"></i></a>
                                </div>
                                <div class="icon-content">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="p-a30 m-b30 radius-sm bg-gray clearfix">
                        ...
                        <form method="post" class="dzForm"
                              action="http://job-board.w3itexperts.com/xhtml/script/contact.php">
                ...
                <div class="col-lg-4 col-md-12 d-lg-flex m-b30">
                    <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d227748.3825624477!2d75.65046970649679!3d26.88544791796718!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x396c4adf4c57e281%3A0xce1c63a0cf22e09!2sJaipur%2C+Rajasthan!5e0!3m2!1sen!2sin!4v1500819483219"
                            class="align-self-stretch radius-sm" style="border:0; width:100%; min-height:350px;"
